  ...
  return (
    <div className="space-y-6">
      <Alert variant="default">
        ...
        <AlertDescription>
          <p className="mb-2">
          Staccdorp powered by AirShip requires a private key to sign transactions and pay for fees. This approach is currently necessary, as other methods aren't yet optimized to sign and send large volumes of transactions. However, it comes with security risks:
          </p>
