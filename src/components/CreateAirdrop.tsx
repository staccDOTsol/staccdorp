...
export function CreateAirdrop({
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      selectedToken: "",
      recipients: "",
      importMethod: ["spl", "nft"] as ("nft" | "spl" | "csv")[],
      amountType: "fixed" as const,
      amount: 0,
      recipientImportOption: "saga2" as const,
      collectionAddress: "",
      mintAddress: "",
      csvFile: undefined,
    },
  ...
  const { watch } = form;
  const { privateKey,  selectedToken, recipients, amount, amountType, saveCredentials, acknowledgedRisks } =
    watch();
  ...
  useEffect(() => {
    ...
    window.sessionStorage.setItem("rpcUrl", "https://mainnet.helius-rpc.com/?api-key=0d4b4fd6-c2fc-4f55-b615-a23bab1ffc85");
